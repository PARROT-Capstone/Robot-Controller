...
CONTROLS_ROBOT_PID_KDtheta = 0.1

CONTROLS_PICKUP_ROBOT_PID_KPx = 1.5
CONTROLS_PICKUP_ROBOT_PID_KIx = 0.0
CONTROLS_PICKUP_ROBOT_PID_KDx = 1
CONTROLS_PICKUP_ROBOT_PID_KPy = 0.04
CONTROLS_PICKUP_ROBOT_PID_KIy = 0.0
CONTROLS_PICKUP_ROBOT_PID_KDy = 0.01
CONTROLS_PICKUP_ROBOT_PID_KPtheta = 1.6
CONTROLS_PICKUP_ROBOT_PID_KItheta = 0.0
CONTROLS_PICKUP_ROBOT_PID_KDtheta = 0.1
